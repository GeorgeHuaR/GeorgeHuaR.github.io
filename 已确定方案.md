...
【测试反馈】
> 我手动更改Layout参数后，发现 feature和standard的图片列占比基本一致，只有compact变化了占比，而PLAN中记录了三种布局参数的效果差异，为何执行修改后前两个参数无差异？
- [建议方案] 拉大 featured 与 standard 的 fr 比例差距，同时降低 featured 的最小值以防止 pinned：
